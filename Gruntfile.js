module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    less: {
      ...
      files: {
        expand: true,
        cwd: "<%= dirs.src %>/assets/less",
        src: "image-gallery.less",
    ...
    watch: {
      ...
      styles: {
        ...
        tasks: ['clean:css','copy','less','csslint','cssmin','bump:prerelease','bower_concat','simple_include','injector','replace','htmlclean'],
        options: {
          spawn: false
        }
      },
